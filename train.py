...
# Dataset
# /root/files/project/CAP-VSTNet/data/content
# /root/files/project/CAP-VSTNet/data/style
parser.add_argument('--train_content', default='/root/files/project/CAP-VSTNet/data/content', help='Directory to dataset A')
parser.add_argument('--train_style', default='/root/files/project/CAP-VSTNet/data/style', help='Directory to dataset B')
...
# resnet for style loss
from models.resnet50 import ResNet50
vgg_enc = ResNet50(None)
vgg_enc.to(device)
